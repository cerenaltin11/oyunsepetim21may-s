    ...
    <header class="navbar">
        <div class="navbar-content">
            ...
            <nav class="nav-links">
                ...
                <a href="{{ route('community.index') }}" class="nav-link {{ request()->routeIs('community*') ? 'active' : '' }}">Topluluk</a>
            </nav>
                    ...
                    <div class="user-dropdown">
                        <div class="dropdown-btn">
                            <div class="user-avatar">
                                @if(Auth::user()->photo)
                                    <img src="{{ asset('images/profiles/' . Auth::user()->photo) }}" alt="{{ Auth::user()->name }}" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
                                @else
                        ...
                        <div class="dropdown-content">
                            @if(Auth::user()->is_admin)
                                <a href="{{ route('admin.panel') }}"><i class="fas fa-tachometer-alt"></i> Panel</a>
                            @endif
